...
function updateSettings(addon, newStyle) {
  ...
  var stylesheet = "";
  var textMode = addon.settings.get("text");
  ...
  for (var _i = 0, _Object$keys = Object.keys(categories); _i < _Object$keys.length; _i++) {
    ...
    if (textMode === "white" || textMode === "black") {
      var tertiary = Object(_libraries_common_cs_text_color_esm_js__WEBPACK_IMPORTED_MODULE_0__["multiply"])(addon.settings.get(propNameForSettings + "-color"), {
        r: 0.8,
        g: 0.8,
        b: 0.8
      });
      ...
      var secondary = Object(_libraries_common_cs_text_color_esm_js__WEBPACK_IMPORTED_MODULE_0__["multiply"])(addon.settings.get(propNameForSettings + "-color"), {
        a: 0.15
      });
      var secondaryActive = Object(_libraries_common_cs_text_color_esm_js__WEBPACK_IMPORTED_MODULE_0__["multiply"])(addon.settings.get(propNameForSettings + "-color"), {
        a: 0.25
      });
      var menuText = {
        colorOnWhite: "#575e75",
...
function _ref2() {
  _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var addon, global, console, otherStyle, newStyle;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            addon = _ref.addon, global = _ref.global, console = _ref.console;
            otherStyle = document.querySelector("[data-addon-id='".concat(addon.self.id, "']"));
            ...
            addon.self.addEventListener("reenabled", function () {
              return newStyle.disabled = false;
            });
