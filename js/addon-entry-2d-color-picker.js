...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _url_loader_assets_sv_gr_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! url-loader!./assets/sv-gr.png */ "./node_modules/url-loader/dist/cjs.js!./src/addons/addons/2d-color-picker/assets/sv-gr.png");
...
var _twGetAsset = function _twGetAsset(path) {
  if (path === "/assets/sv-gr.png") return _url_loader_assets_sv_gr_png__WEBPACK_IMPORTED_MODULE_0__["default"];
...
/* harmony default export */ __webpack_exports__["default"] = (/*#__PURE__*/(function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var addon, console, msg, prevEventHandler, rateLimiter, getColor, setColor, convertToGeneralColor, _loop, _ret;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            // 250-ms rate limit
            rateLimiter = new _libraries_common_cs_rate_limiter_js__WEBPACK_IMPORTED_MODULE_2__["default"](250); // get the color from scratch

            getColor = function getColor(element) {
              var fillOrStroke;
              var state = addon.tab.redux.state;
              ...
              var colorType = state.scratchPaint.fillMode.colorIndex;
              var primaryOrSecondary = ["primary", "secondary"][colorType];
              var color = state.scratchPaint.color["".concat(fillOrStroke, "Color")][primaryOrSecondary];
            ...
            setColor = function setColor(hex, element) {
              ...
              var onEyeDropperOpened = function onEyeDropperOpened(_ref3) {
                ...
                setTimeout(function () {
                  var previousTool = addon.tab.redux.state.scratchPaint.color.eyeDropper.previousTool;
            ...
            convertToGeneralColor = function convertToGeneralColor(hex) {
              var h = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_3__["default"])(hex).toHsv();
              h.s = 1;
              h.v = 1;
            ...
            _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop() {
              var element, updateColor, defaultColor, saColorPicker, saColorPickerImage, saColorPickerHandle, saColorLabel, saColorLabelName, saColorLabelVal, keyPressed, originalPos, origHue, el, mousemovefunc, mouseupfunc, updateHandle, updateHandleFinal, updateFinal, defaultHexColor, _map, _map2, colorSlider, saturationSlider, brightnessSlider;

              return regeneratorRuntime.wrap(function _loop$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      updateFinal = function _updateFinal(e, keyPressed, originalPos) {
                        rateLimiter.limit(function () {
                          var ox = Math.min(Math.max(e.clientX - saColorPicker.getBoundingClientRect().x, 0), 150);
                          var oy = Math.min(Math.max(e.clientY - saColorPicker.getBoundingClientRect().y, 0), 150);

                          if (keyPressed === 16) {
                            if (Math.abs(ox - originalPos.x) > Math.abs(oy - originalPos.y)) oy = originalPos.y;else ox = originalPos.x;
                          }

                          var color = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_3__["default"])(getColor(element)).toHsv();
                          var s = ox / 150;
                          var v = 1 - oy / 150;
                          var newColor = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_3__["default"])({
                            h: color.h,
                            s: s,
                            v: v,
                            a: color.a
                      ...
                      updateHandleFinal = function _updateHandleFinal(s, v) {
                      ...
                      updateHandle = function _updateHandle(e, keyPressed, originalPos) {
                        var cx = Math.min(Math.max(e.clientX - saColorPicker.getBoundingClientRect().x, 0), 150);
                        var cy = Math.min(Math.max(e.clientY - saColorPicker.getBoundingClientRect().y, 0), 150);
                        ...
                        if ((!addon.tab.redux.state.scratchPaint.fillMode.gradientType || addon.tab.redux.state.scratchPaint.fillMode.gradientType === "SOLID") && el) {
                          var c = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_3__["default"])({
                            h: origHue,
                            s: cx / 150,
                            v: 1 - cy / 150
                          }).toHex();
                      ...
                      updateColor = function _updateColor() {
                        rateLimiter.limit(function () {
                          var c = getColor(element);
                          var chsv = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_3__["default"])(c).toHsv();
                      ...
                      _context.next = 6;
                      return addon.tab.waitForElement('div[class*="color-picker_swatch-row"]', {
                        markAsSeen: true,
                    ...
                    case 11:
                      ...
                      addon.tab.redux.addEventListener("statechanged", function (e) {
                        return e.detail.action.type === "scratch-paint/fill-style/CHANGE_FILL_COLOR" || e.detail.action.type === "scratch-paint/fill-style/CHANGE_FILL_COLOR_2" || e.detail.action.type === "scratch-paint/stroke-style/CHANGE_STROKE_COLOR" || e.detail.action.type === "scratch-paint/stroke-style/CHANGE_STROKE_COLOR_2" ? updateColor() : 0;
                      });
                    ...
                    case 16:
                      ...
                      saColorLabelVal = document.createElement("span");
                      ...
                      mouseupfunc = function mouseupfunc(e) {
                        updateFinal(e, keyPressed, originalPos);
                      };

                      if (defaultColor) {
                        defaultHexColor = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_3__["default"])(defaultColor).toHsv();
                        updateHandleFinal(defaultHexColor.s, defaultHexColor.v);
                      } else updateHandleFinal(1, 1);

                      saColorPicker.addEventListener("pointerdown", function (e) {
                        e.preventDefault();
                        originalPos = {
                      ...
                      prevEventHandler = function prevEventHandler(_ref4) {
                      ...
                      _map = _toConsumableArray(element.parentElement.querySelectorAll('[class^="color-picker_row-header"]')).map(function (i) {
                        return i.parentElement;
                      }), _map2 = _slicedToArray(_map, 3), colorSlider = _map2[0], saturationSlider = _map2[1], brightnessSlider = _map2[2];
