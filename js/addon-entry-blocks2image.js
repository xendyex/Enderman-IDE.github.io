...
function _ref2() {
  _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref) {
    var addon, global, console, msg, style, exSVG, blocksMedia, exportBlock, selectedBlocks, allBlocks, exportData, exportPNG;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            exportBlock = function _exportBlock(isExportPNG, block) {
              var svg;
            ...
            exSVG = document.createElement("svg");
            ...
            exSVG.setAttribute("version", "1.1"); // blocks-media as base64 for svg inline image
            ...
            addon.tab.createBlockContextMenu(function (items) {
              ...
              var insertBeforeIndex = pasteItemIndex !== -1 ? // If "paste" button exists, add own items before it
