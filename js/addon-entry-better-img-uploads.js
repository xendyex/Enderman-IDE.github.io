...
function _ref2() {
  _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref) {
    var addon, console, msg, mode, createItem, _loop, onchange, _onchange, FileList;

    return regeneratorRuntime.wrap(function _callee2$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            FileList = function _FileList() {
              var arr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
              //File list constructor. Does not need the `new` keyword, but it is easier to read
              var filelist = new DataTransfer(); //This "creates" a FileList that we can add files to
            ...
            _onchange = function _onchange3() {
              _onchange = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e, id) {
                var iD, el, files, processed, _loop2, _i2, _files, _ret;

                return regeneratorRuntime.wrap(function _callee$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        iD = id; //Save the id, not sure if this is really necessary?

                        el = e.target;
                        files = Array.from(el.files);
                        processed = new Array();
                        _loop2 = /*#__PURE__*/regeneratorRuntime.mark(function _loop2() {
                          var file, blob, i, dim, originalDim, getResizedWidthHeight;
                          return regeneratorRuntime.wrap(function _loop2$(_context2) {
                            while (1) {
                              switch (_context2.prev = _context2.next) {
                                case 0:
                                  getResizedWidthHeight = function _getResizedWidthHeigh(oldWidth, oldHeight) {
                                    var STAGE_WIDTH = 479;
                                ...
                                case 7:
                                  blob = _context2.sent;
                                  i = new Image(); //New image to get the image's size
                                ...
                                case 12:
                                  ...
                                  originalDim = JSON.parse(JSON.stringify(dim));
                      ...
                      case 6:
                        ...
                        return _context3.delegateYield(_loop2(), "t0", 8);
            ...
            onchange = function _onchange2(_x2, _x3) {
              return _onchange.apply(this, arguments);
            };
            ...
            createItem = function createItem(id, right) {
              var uploadMsg = msg("upload");
              ...
              var tooltip = Object.assign(document.createElement("div"), {
            ...
            _loop = /*#__PURE__*/regeneratorRuntime.mark(function _loop() {
              var menu, button, id, isRight, _createItem, _createItem2, menuItem, hdButton, input, tooltip, observer, doresize;

              return regeneratorRuntime.wrap(function _loop$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      doresize = function _doresize(id, menu, menuItem, isRight) {
                      ...
                      _context.next = 3;
                      return addon.tab.waitForElement('[class*="sprite-selector_sprite-selector_"] [class*="action-menu_more-buttons_"], [data-tabs] > :nth-child(3) [class*="action-menu_more-buttons_"]', {
                        markAsSeen: true
                      });

                    case 3:
                      menu = _context.sent;
                      button = menu.parentElement.previousElementSibling.previousElementSibling; //The base button that the popup menu is from

                      id = button.getAttribute("aria-label").replace(/\s+/g, "_");
                      isRight = //Is it on the right side of the screen?
                      ...
                      _createItem = createItem(id, isRight), _createItem2 = _slicedToArray(_createItem, 4), menuItem = _createItem2[0], hdButton = _createItem2[1], input = _createItem2[2], tooltip = _createItem2[3];
                      menu.prepend(menuItem);
                      hdButton.addEventListener("click", function (e) {
                      ...
                      observer = new MutationObserver(function () {
                        return doresize(id, menu, menuItem, isRight);
                      });
